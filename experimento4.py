...
# --- Configuración ---
centros_vals = [10, 20, 30]  # puedes ampliar si quieres
...
for c in centros_vals:
    ...
    for r in range(reps):
        ...
        with open(latest_file, "r") as f:
            ...
            tiempos_sa.append(float(lines[2]))  # línea del tiempo de ejecución
        ...
        with open(latest_file, "r") as f:
            lines = [l.strip() for l in f.readlines() if not l.startswith("#") and l.strip()]
            tiempos_hc.append(float(lines[2]))
...
plt.title("Evolución del tiempo de ejecución según tamaño del problema")
plt.legend()
plt.grid(True)
plt.show()
